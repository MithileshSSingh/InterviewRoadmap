    ...
    <div>
      ...
      >
        <div className="roadmap-card-inner">
          ...
          <p>
            Get a personalized AI-generated career roadmap — interview intel,
            salary data, LinkedIn referral strategy, and a phased study plan for
            any role at any company.
          </p>
          <div className="roadmap-tags">
            {["AI-Powered", "Multi-Agent", "Real-Time", "Personalized"].map(
              (tag) => (
              ...
              {roadmap.comingSoon ? (
                ...
                >
                  ...
                  <span className="roadmap-count">
                    {topicCount} topics · {phases.length} phases →
                  </span>
                </Link>
              )}
            </div>
